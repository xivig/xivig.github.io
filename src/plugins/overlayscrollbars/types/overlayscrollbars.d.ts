 ...
 */
type ScrollbarsClickScrollBehavior = boolean | 'instant' | ((isHorizontal: boolean) => Partial<ScrollbarsClickScrollBehaviorOptions> | false | null | undefined | void);
/**
 ...
 */
type OptionsDebounceLegacy = OptionsDebounceValue;
/**
...
declare const ScrollbarsHidingPlugin: {
    __osScrollbarsHidingPlugin: {
        static: () => {
            _viewportArrangement: (structureSetupElements: DeepReadonly<StructureSetupElementsObj>, structureSetupState: DeepReadonly<StructureSetupState>, observersSetupState: DeepReadonly<ObserversSetupState>, env: Env, checkOptions: OptionsCheckFn<Options>) => {
...
declare const ClickScrollPlugin: {
    __osClickScrollPlugin: {
        static: () => (scrollRelative: (deltaScroll: number) => void, moveHandleRelative: (deltaMovement: number) => void, getHandleOffset: () => number, targetDeltaMovement: number, viewportSize: number, clickScrollOption: ScrollbarsClickScrollBehavior, isHorizontal: boolean, onClickScrollCompleted: (stopped: boolean) => void) => (stopClick?: boolean) => void;
    };
};
